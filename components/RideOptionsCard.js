...
const RideOptionsCard = () => {
    ...
    return (
        <SafeAreaView style={tw`bg-white flex-grow`}>
            <View>
                <TouchableOpacity onPress={() => navigation.navigate("NavigateCard")} style={tw`absolute top-1 left-5 p-3 rounded-full`}>
            ...
            />
            <View>
                <TouchableOpacity disabled={!selected} style={tw`bg-black py-2 mb-3 mx-3 ${!selected && "bg-gray-300"}`}>
